...
4. Détaille précisément le Jour 1 avec toutes les étapes, horaires et coordonnées GPS réelles.
5. RÈGLE HÉBERGEMENT : le champ "overnight" n'est PAS une étape d'activité. Il ne doit JAMAIS apparaître dans "steps". Il représente la zone où dormir, cohérente géographiquement avec la dernière activité et le lendemain.
...
8. Fournis un aperçu des jours 2 à ${Math.min(Number(days), 7)} (titres + highlights seulement).
